...
class NUSCENESHP(data.Dataset):
    ...
    def __init__(self, opt, split):
        ...
        self.data_dir = os.path.join(opt.data_dir, 'nuscenes')
        ...
        self.annot_path = os.path.join(self.data_dir, 'annotations/annotations_{}/nuscene_train.json'.format(opt.num_joints-9))
        self.max_objs = 96
